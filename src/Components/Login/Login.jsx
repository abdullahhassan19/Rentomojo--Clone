  ...
  //console.log(finalOtp)
   ...
   const handleLogin = () => {
    ...
    if(got == finalOtp.join("")){
      ...
      document.getElementById("top").innerText=`${logo} .`
      document.getElementById("top1").style.backgroundColor="green";
      document.getElementById("top1").innerText=`${name}.`
      onClose()
      setVerify(!verify)
      setLogout(true)
    }
  ...
  //  }
   ...
   const handleLogout = () => {
    ...
    setLogout(false);
      ...
      document.getElementById("top").innerText=`Loggin`
      document.getElementById("top1").style.backgroundColor="#dc3226";
      document.getElementById("top1").innerText=`/SignUp`
      onClose();
      setVerify(false)
   }
    ...
    return (
      <>
        ...
        <Button id="top1" onClick={onOpen} style={{backgroundColor:"#dc3226",color:"white" , marginLeft:"-25px" }}>/Signup</Button>
